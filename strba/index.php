...
<html><head>
    ...
    <label for="angle">Zadajte r(nová poloha Guličky)</label>
    <input type="number" min="-40" max="40" name="name" value = 0>
    ...
    <div>
        <ul id="pecko"> <?php echo json_encode($op); ?>  </ul>
    </div>
    ...
    <iframe name="hiddenFrame" width="0" height="0"  style="display: none;"></iframe>
        ...
        $('#btn').click(function(event){
            ...
            var data = {
              ...
              $.get('http://147.175.121.210:8108/FINALNEZADANIE/ScriptOCT.php/<?php if(isset($_POST['name'])){echo $_POST['name'];}else{echo '0';}?> ' )
              .done((dataa)  =>  
              {
